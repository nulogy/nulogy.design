      ...
      Object(h.setLoader)(U),
        ...
        Object(o.apiRunnerAsync)("onClientEntry").then(function() {
          ...
          var e = function(e) {
                            ...
                            Object.assign(
                              {
                                path:
                                  "/404.html" === r.page.path
                                    ? Object(T.a)(o.pathname, "/nulogy.design")
            ...
            g = p.location;
          m &&
            "/nulogy.design" + m !== g.pathname &&
            !(
              U.findMatchPath(Object(T.a)(g.pathname, "/nulogy.design")) ||
              "/404.html" === m ||
              m.match(/^\/404\/?$/) ||
              m.match(/^\/offline-plugin-app-shell-fallback\/?$/)
            ) &&
            Object(u.navigate)("/nulogy.design" + m + g.search + g.hash, {
              replace: !0
            }),
            ...
            (t.prototype.render = function() {
              ...
              if (m) {
                ...
                var w = f({}, g, {
                  ...
                  S = a ? _ : c,
                  O = a ? f({ uri: v, location: t, component: c }, u) : u;
                return o.a.createElement(
                  j.Provider,
    ...
    emEt: function(e, t, n) {
      ...
      var h = new Map(),
        ...
        g = function(e) {
          ...
          return Object(l.a)(t, "/nulogy.design")
            .split("#")[0]
            .split("?")[0];
        };
      function v(e) {
        ...
        E = (function() {
          ...
          return (
                ...
                var o = r.payload,
                  ...
                  f = Promise.all(
                    u.map(function(e) {
                      ...
                      return t
                        .memoizedGet("/nulogy.design/static/d/" + e + ".json")
                        .then(function(t) {
            ...
            (t.loadAppData = function(e) {
              ...
              return (
                void 0 === e && (e = 0),
                this.memoizedGet("/nulogy.design/page-data/app-data.json").then(
                  function(n) {
                    var r,
                      o = n.status,
                      a = n.responseText;
...
//# sourceMappingURL=app-8946f758a3f6fa48494b.js.map
