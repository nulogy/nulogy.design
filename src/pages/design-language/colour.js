    ...
    <Page title="" location={location}>
      <Box maxWidth="1024px" m="0 auto">
        <Box mb="x2">
          ...
          <Text fontSize="24px" mb="x2">
            Colours are used to set a visual tone, communicate meaning, and
            create a cohesive experience between Nulogy products and the
            physical environment. We are committed to complying with WCAG AA
            contrast ratios.
          </Text>
          <Text fontSize="24px" mb="x6">
            <Link href={FIGMA_LINK} fontSize="24px">
              View colours in Figma
            </Link>{" "}
            |{" "}
            <Link href="/theme" fontSize="24px">
              View theme file
            </Link>
          </Text>
        </Box>
        ...
        <Flex>
          <Palette
            ...
            context="The default text colour."
          />
        ...
        <Flex mb="x6">
          <Palette
            ...
            context="The default link colour."
          />
        ...
        <Text fontSize="24px" mb="x4">
          These colours are generally used to build out the backgrounds and
          layers in our user interfaces.
        </Text>
        <Flex>
        ...
        <Text fontSize="24px" mb="x4">
          For providing meaning. For accessibility reasons, make sure the colour
          is not the sole way of doing this.
        </Text>
        ...
        <Flex>
          ...
          <Palette
            ...
            context="To communicate success"
          />
        </Flex>
        <Flex>
          <Palette
            name="lightGreen"
            colour={theme.colors.lightGreen}
            context="Success accent colour"
          />
          <Palette
            name="yellow"
            colour={theme.colors.yellow}
            context="To warn about something non-destructive"
          />
          <Palette
            name="lightYellow"
            colour={theme.colors.lightYellow}
            context="Warning accent colour"
          />
        </Flex>
        <Divider mb="x6" />
        <Heading2>Categorical colours</Heading2>
        <Text fontSize="24px" mb="x4">
          These are used for charting and other data visualization. See{" "}
          <Link fontSize="24px" href="/patterns/data-visualization">
            Data Visualization
          </Link>{" "}
