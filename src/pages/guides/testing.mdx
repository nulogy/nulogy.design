...
A guide to writing automated tests for NDS components. Here you can find information about how we write our own tests for the library and how to use selectors when writing tests for your own application that uses NDS components.
...
- [Unit testing example](https://github.com/nulogy/design-system/blob/master/src/Select/Select.spec.tsx)

## End-to-end Tests

End-to-end tests are how we check our components are behaving correctly e.g: “When a user clicks a button does that open a dropdown menu?” We write these with [Cypress](https://www.cypress.io/).

- [e2e testing example](https://github.com/nulogy/design-system/blob/master/cypress/integration/components/Select.spec.js)
