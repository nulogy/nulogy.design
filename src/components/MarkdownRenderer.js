...
import {Alert, Text, Link, List, ListItem, Heading1, Heading2, Heading3, Heading4} from "@nulogy/components";
...
function MarkdownRenderer({ children }) {
  return (
    <MDXProvider components={{
      ...
      h4: (props) => <Heading4 maxWidth={COPY_WIDTH}  mt="x4" mx="auto" {...props} />,
      ...
      table: (props) => <table style={{width: "100%", textAlign: "left", maxWidth: COPY_WIDTH, margin: "32px auto"}} {...props} />,
      Alert: (props) => <Alert maxWidth={COPY_WIDTH} m="0 auto" mb="x4" {...props} />,
      Playground,
      Example,
      PropsTable,
    }}>
