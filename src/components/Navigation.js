...
const Navigation = () => (
    <>
            ...
            {navigationLinks.map(menuItem => (
              <Box mb="x6">
              <Text fontSize="14px" color="darkGrey" textTransform="uppercase" fontWeight="bold" marginY="x3">{menuItem.name}</Text>
                <List pl="0">
                <>
          ...
          <Text mb="x6" fontSize="14px" color="darkGrey" textTransform="uppercase" fontWeight="bold" marginY="x3">CONTENT <StatusIndicator ml="half">Coming soon</StatusIndicator></Text>
          </>
)
